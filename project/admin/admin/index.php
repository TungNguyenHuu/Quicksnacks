...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="../quantri/quantri.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			<li><a href="trangchucnang.php"><em class="fa fa-calendar">&nbsp;</em> Chức Năng</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="col-sm-12">
			<p class="back-link"> The Team <a href="#">Maudz</a></p>
		</div>
		</div><!--/.row-->
	</div>	<!--/.main-->
